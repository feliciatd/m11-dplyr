...
pulitzer <- mutate(pulitzer, Pulitzer.Prize.Change = Pulitzer.Prize.Winners.and.Finalists..1990.2014 - Pulitzer.Prize.Winners.and.Finalists..2004.2014)

# What publication gained the most pulitzer prizes from 2004-2014?
# Be sure to use the pipe operator! 
pulitzer %>% filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 == max(Pulitzer.Prize.Winners.and.Finalists..2004.2014)) %>% 
              select(Newspaper)
...
pulitzer %>% filter(Pulitzer.Prize.Winners.and.Finalists..2004.2014 >= 5) %>% 
